...
class OpenAIChatSession():
    ...
    def chat(self, message: Union[str, List[Dict[str, Any]]]) -> str:
        """
        Adds a message to the chat history, sends a chat completion request, and returns the response.

        Parameters:
            message (str or list): The message to process. This can either be a string representing a single message
                or a list following the allowed structure for the content section (e.g., [{'role': 'user', 'content': message}]).
