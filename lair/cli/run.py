...
def parse_arguments():
    ...
    parser.add_argument('--disable-color', '-c', action='store_true', default=False,
                        help='Do not use color escape sequences')
    parser.add_argument('--force-color', '-C', action='store_true', default=False,
                        help='Use color escape sequences, even in pipes')
    parser.add_argument('-M', '--mode', type=str,
                        help='Name of the predefined mode to use')
    parser.add_argument('-m', '--model', type=str,
                        help='Name of the model to use')
    parser.add_argument('-s', '--set', action='append', type=str,
                        help="Set a configuration value (-s key=value)")
